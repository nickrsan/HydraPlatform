...
def gmdAddSymbolX(*args):
  """gmdAddSymbolX(pgmd, symName, aDim, stype, userInfo, explText, vDomPtrIn, keyStr_in) -> void *"""
  return _gmdcc.gmdAddSymbolX(*args)

def gmdAddSymbol(*args):
  """gmdAddSymbol(pgmd, symName, aDim, stype, userInfo, explText) -> void *"""
...
def gmdCheckDomain(*args):
  """gmdCheckDomain(pgmd, dvHandle, symPtr, INOUT, symIterPtr, INOUT, viol) -> int"""
  return _gmdcc.gmdCheckDomain(*args)
...
def gmdGetFirstDBDV(*args):
  """gmdGetFirstDBDV(pgmd, status) -> void *"""
  return _gmdcc.gmdGetFirstDBDV(*args)

def gmdGetFirstDVInSymbol(*args):
  """gmdGetFirstDVInSymbol(pgmd, symPtr, status) -> void *"""
  return _gmdcc.gmdGetFirstDVInSymbol(*args)
...
def gmdGetDVSymbol(*args):
  """gmdGetDVSymbol(pgmd, dvHandle, status) -> void *"""
  return _gmdcc.gmdGetDVSymbol(*args)

def gmdGetDVSymbolRecord(*args):
  """gmdGetDVSymbolRecord(pgmd, dvHandle, status) -> void *"""
  return _gmdcc.gmdGetDVSymbolRecord(*args)
