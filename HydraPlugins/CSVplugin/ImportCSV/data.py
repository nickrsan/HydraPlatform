            ...
            if expand_filenames:
                ...
                if len(data) == 0:
                    ...
                    if is_timeseries(data):
                        ...
                        ts = create_timeseries(data, restriction_dict, header=value_header, filename=value, timezone=timezone)
...
def create_timeseries(data, restriction_dict={}, header=None, filename="", timezone=pytz.utc):
    """
        Create a timeseries object (dictionary) from csv data. 
    """
    ...
    validate_value(ts_values, restriction_dict)
