...
def add_network(user_id, network):
    """
...
def get_network_as_dict(user_id, network_id, include_data, scenario_ids, template_id):
    """
    ...
    net = net_i.get_as_dict(include_attrs=False)
...
def get_network_by_name(user_id, project_id, network_name):
    """
    ...
    include_data = 'Y'
    #try:
    #    check_perm(user_id, 'view_data')
    #except:
    #    include_data='N'

    net = net_i.get_as_dict(**dict(include_data=include_data))

    return net

def update_network(user_id, network):
    """
        Update an entire network
    """

    #check_perm(user_id, 'update_network')
...
def delete_network(user_id, network_id, purge_data):
    """
...
def get_network_extents(user_id, network_id):
    """
...
def add_node(user_id, network_id, node):
...
def delete_resourceattr(user_id, resource_attr_id, purge_data):
    """
...
def purge_node(user_id, node_id, purge_data):
    """
...
def add_link(user_id, network_id, link):
    """
...
def purge_link(user_id, link_id, purge_data):
    """
...
def add_group(user_id, network_id, group):
    """
...
def get_scenarios(user_id, network_id):
    """
...
def validate_network_topology(user_id, network_id):
    """
