...
def share_network(user_id, network_id, usernames, read_only, share):
    """
...
def share_project(user_id, project_id, usernames, read_only, share):
    """
...
def set_project_permission(user_id, project_id, usernames, read, write, share):
    """
...
def set_network_permission(user_id, network_id, usernames, read, write, share):
    """
...
def lock_dataset(user_id, dataset_id, exceptions, read, write, share):
    """
