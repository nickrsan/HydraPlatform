...
def upload_template_xml(user_id, template_xml):
    """
...
def get_matching_resource_types(user_id, resource_type, resource_id):
    """
...
def assign_types_to_resources(user_id, resource_types):
...
def assign_type_to_resource(user_id, type_id, resource_type, resource_id):
...
def add_template(user_id, template):
    """
...
def update_template(user_id, template):
    """
...
def remove_attr_from_type(user_id, type_id, attr_id):
    """
...
def get_template_by_name(user_id, name):
    """
...
def add_templatetype(user_id, templatetype):
    """
...
def update_templatetype(user_id, templatetype):
    """
...
def get_templatetype(user_id, type_id):
    """
...
def get_templatetype_by_name(user_id, template_id, type_name):
    """
...
def add_typeattr(user_id, typeattr):
    """
...
def delete_typeattr(user_id, typeattr):
    """
...
def get_network_as_xml_template(user_id, network_id):
    """
